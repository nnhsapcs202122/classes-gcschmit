...
public class CaesarCipher
{
    ...
    public String getComplexityDescription(int secPerGuess)
    {
         ...
         *      By convention, constaatnts are in all caps with underscores.
         */
         ...
         *  
         *  Java goes integer division when both operands are integer types;
         ...
         *      (e.g., int to a double, double to int, int to a long)
         *      
         ...
         * 
         *  If the two operands are of differnt types, Java attempts to promote one
         ...
         *      yearsAsDecimal.
         *      
         *  The local variable SECONDS_FOR_EVERY_YEAR is still a long and still has the
         *      same value.
         */
     ...
     */
    public void compressKeyphrase(String initKeyphrase)
    {
        this.keyphrase = "";
        ...
        for(int i = 0; i < keyphraseLength; i++)
        {
             ...
             *          up to, but not including, the second specific index
             *      if only one index is specified, returns part ofthe string starting
             ...
             *          objects); otherise, + is the addition operator
             *          
             *  int x = 7;
    ...
    /**
     * Generates a psuedorandom keyphrase of the specified length in characters
     * 
     * @param length the number of characters is the keyphrase
